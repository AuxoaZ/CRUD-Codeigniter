            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="<?= base_url('auth'); ?>" method="post">
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" name="email" placeholder="Enter email address.." value="<?= set_value('email'); ?>">
                    ...
                    <div class="wrap-input100 validate-input mt-3 " id="show_hide_password">
